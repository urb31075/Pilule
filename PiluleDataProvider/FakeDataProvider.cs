    ...
    public class FakeDataProvider : IPiluleDataProvider
    {
        ...
        public ObservableCollection<BaskeеtData> GetData(Action onBaskeеtChanged)
        {
            var baskeеt = new ObservableCollection<BaskeеtData>
                 {
                     new BaskeеtData(onBaskeеtChanged) { Id = 0, Name = "Fake Good №1", Amount = 1, Price = 2 },
                     new BaskeеtData(onBaskeеtChanged) { Id = 1, Name = "Fake Good №2", Amount = 2, Price = 4 },
                     new BaskeеtData(onBaskeеtChanged) { Id = 2, Name = "Fake Good №3", Amount = 3, Price = 8 },
                     new BaskeеtData(onBaskeеtChanged) { Id = 3, Name = "Fake Good №4", Amount = 4, Price = 16 }
                 };
            return baskeеt;
        }
